...
export class CreateSchema1662071635898 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."users_type_enum" AS ENUM('auditor', 'manager')`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."audits_type_enum" AS ENUM('internal', 'external')`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "questions" ADD CONSTRAINT "FK_a40e5497291ddbe799af622efa9" FOREIGN KEY ("form_id") REFERENCES "forms"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_6212769db7311d1d7e27d4416f"`
    );
    await queryRunner.query(`DROP TABLE "answers_evidences"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_f2fa95533c1ff6187b92676e63"`
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_7d0d403c389006b2cbc1c97bba"`
    );
    await queryRunner.query(`DROP TABLE "audits_forms"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_f92a09b163937be192311ad05a"`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP TYPE "public"."answers_conformance_level_enum"`
    );
